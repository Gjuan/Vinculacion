 ...
 * @author jorge
 */
public class JFrameNuevoDepartamento extends javax.swing.JDialog {

    public JFrameNuevoDepartamento(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
        Iconos.setSameDefault(this, "Nuevo departamento");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(JFrameNuevoDepartamento.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                JFrameNuevoDepartamento dialog = new JFrameNuevoDepartamento(new javax.swing.JFrame(), true);
