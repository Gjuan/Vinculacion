 ...
 * @author jorge
 */
public class JFrameNuevaSeccion extends javax.swing.JDialog {

    public JFrameNuevaSeccion(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
        Iconos.setSameDefault(this,"Nueva sección");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(JFrameNuevaSeccion.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                JFrameNuevaSeccion dialog = new JFrameNuevaSeccion(new javax.swing.JFrame(), true);
