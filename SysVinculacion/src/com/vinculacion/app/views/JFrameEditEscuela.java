 ...
 * @author jorge
 */
public class JFrameEditEscuela extends javax.swing.JDialog {

    public JFrameEditEscuela(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
        this.setTitle("Editar Escuelas");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(JFrameEditEscuela.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                JFrameEditEscuela dialog = new JFrameEditEscuela(new javax.swing.JFrame(), true);
