 ...
 * @author jorge
 */
public class JFrameEditEmpleado extends javax.swing.JDialog {

    public JFrameEditEmpleado(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
        Iconos.setSameDefault(this, "Editar empleados");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(JFrameEditEmpleado.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                JFrameEditEmpleado dialog = new JFrameEditEmpleado(new javax.swing.JFrame(), true);
