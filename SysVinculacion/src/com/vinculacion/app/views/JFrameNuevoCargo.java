...
public class JFrameNuevoCargo extends javax.swing.JDialog {

    public JFrameNuevoCargo(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
        Iconos.setSameDefault(this, "Nuevo Cargo");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(JFrameNuevoCargo.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                JFrameNuevoCargo dialog = new JFrameNuevoCargo(new javax.swing.JFrame(), true);
