 ...
 * @author jorge
 */
public class JFrameNuevoGenero extends javax.swing.JDialog {

    /**
     * Creates new form JFrameNuevoGenero
     */
    public JFrameNuevoGenero(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
        Iconos.setSameDefault(this, "Nuevo Género");
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(JFrameNuevoGenero.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                JFrameNuevoGenero dialog = new JFrameNuevoGenero(new javax.swing.JFrame(), true);
