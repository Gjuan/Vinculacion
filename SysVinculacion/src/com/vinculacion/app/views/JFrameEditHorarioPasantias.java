...
public class JFrameEditHorarioPasantias extends javax.swing.JDialog {

    
    public JFrameEditHorarioPasantias(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
        Iconos.setSameDefault(this, "Editar Horarios de pasantías");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(JFrameEditHorarioPasantias.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                JFrameEditHorarioPasantias dialog = new JFrameEditHorarioPasantias(new javax.swing.JFrame(), true);
